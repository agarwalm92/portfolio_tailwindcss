export const Bio = {
    ...
    description:
        "A Full Stack .NET Developer, Post Graduate in Master of Computer Application (MCA), from Thakur College with 6+ years of experience, delivering high performance Web App, Desktop and Mobile Applications. Experience in working for a SaaS model in Supply chain logistics. Interested in taking new challenges and learning new skills. I am a motivated and versatile individual, always eager to take on new challenges. With a passion for learning I am dedicated to delivering high-quality results. With a positive attitude and a growth mindset, I am ready to make a meaningful contribution and achieve great things.",
